...
function Help() {
    ...
    return (
        <div>
            <div className="flex justify-between p-8 m-auto items-center w-full font-bold bg-[#061f77]">
            ...
            <form action="" className="h-[100vh] text-center">
                ...
                <select value={selectedValue} onChange={handleChange} className="p-8 m-auto  text-center border-4">
